...
from kernel_helper import GraphicObj, cvt_figs_to_graphic_obj
...
def new_figure_manager_given_figure(num, figure):
    ...
    if not hasattr(figure, 'show'):
        def dummy_show(): pass
        # print("warning: matplotlib figure no show attr")
        figure.show = lambda *args: dummy_show()
...
def show(close=None, block=None):
    ...
    return cvt_figs_to_graphic_obj([fm.canvas.figure for fm in Gcf.get_all_fig_managers()])
