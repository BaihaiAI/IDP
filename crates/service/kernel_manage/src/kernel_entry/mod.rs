...
impl KernelEntry {
    pub async fn new(
        ...
        ctx.broadcast_output_to_all_ws_write
        ...
        tokio::spawn({
            ...
            let output_to_ws_sender = ctx.broadcast_output_to_all_ws_write.clone();
...
pub struct KernelCtx {
    ...
    /// (core_dumped_cell_id, core_dumped_reason)
    core_dumped_cell_id: Option<(String, String)>, // kernel_info: kernel_common::KernelInfo,
...
impl KernelCtx {
    ...
    fn shutdown(&mut self) {
        ...
        if let Some((ref cell_id, ref core_dumped_reason)) = self.core_dumped_cell_id {
            ...
            let msg = kernel_common::Message {
                ...
                content: kernel_common::Content::RuntimeError {
                    message: format!("kernel core_dumped {core_dumped_reason}"),
                },
            };
